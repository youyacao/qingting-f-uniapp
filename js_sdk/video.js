...
export function getVideo(id) {
	return request.post("movie/view", {
		movie_id: id
	})
}

export function getVideoList(id) {
	return request.post("movie/detailList", {
		movie_id: id,
		limit: 100
	})
}
...
export function addDownlaodHistory(vid) {
	return request.post('download', { type: 1, vid })
}

export function downlaodHistory(data) {
	return request.post('downloadList', data)
}
